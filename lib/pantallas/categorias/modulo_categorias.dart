...
class ModuloCategorias extends StatelessWidget {
  const ModuloCategorias({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            _botonOperacion(context, 'Listar Categorias', '/listarCategorias'),
            const SizedBox(height: 16),
            _botonOperacion(context, 'Agregar Categorias', '/agregarCategorias'),
            const SizedBox(height: 16),
            _botonOperacion(context, 'Editar Categorias', '/editarCategorias'),
            const SizedBox(height: 16),
            _botonOperacion(context, 'Eliminar Categorias', '/eliminarCategorias'),
          ],
        ),
      ),
    );
